...
export default function StaffDashboardPage() {
  ...
  return <main className="staff-menu page-width"><a href="#home">Restaurant website</a><header className="staff-heading"><div><h1>Restaurant staff</h1><p>Signed in as {user.username} · {user.role}</p></div><button onClick={logout}>Sign out</button></header>
    <div className="order-queue">
      ...
      {user.role === 'ADMIN' && <><a className="order-panel" href="#/staff/restaurant"><h2>Restaurant scheduling</h2><p>Manage timezone, opening hours and closed dates.</p></a><a className="order-panel" href="#/staff/menu"><h2>Menu administration</h2><p>Manage dishes, prices and photographs.</p></a><a className="order-panel" href="#/staff/users"><h2>Staff accounts</h2><p>Create accounts, set roles and reset passwords.</p></a></>}
    </div>
  </main>;
}
