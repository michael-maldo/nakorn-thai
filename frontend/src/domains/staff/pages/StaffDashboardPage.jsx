...
export default function StaffDashboardPage() {
  ...
  return <main className="staff-overview">
    ...
    <section className="staff-shell-welcome" aria-labelledby="workspace-title"><span className="staff-shell-mark" aria-hidden="true">NT</span><h2 id="workspace-title">You’re signed in.</h2><p>Use the workspace navigation to open the tools available to your role.</p><p>Open Orders to manage the current queue and move orders through your role’s workflow.</p><p><a href="#/staff/orders">{user.role === 'BOH' ? 'Open kitchen orders' : 'Open orders'}</a></p>
      </section>
  </main>;
}
